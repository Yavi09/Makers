        ...
        <form method="post">
            <div class="container">
                ...
                <div class="buttons-reservacion form-data">
                    ...
                    <button type="submit" class="btn btn-makers" id="crear" @submit.prevent="validateCrear">Agregar</button>
    ...
    methods: {
        ...
        validateCrear(e) {
            ...
            if ((cliente.nombres && cliente.apellidos && cliente.clave && cliente.telefono) !== '') {
                ...
                // validar dui
                else if (cliente.dui) { (!formatDui(cliente.dui)) ? this.msg = 'Formato de DUI incorrecto' : this.msg = ''; }
                // validar contraseña mayor a 10 caracteres
                else if (cliente.clave) { (cliente.clave.length < 10) ? this.msg = 'Contraseña debe ser mayor a 8 caracteres' : this.msg = ''; }
                // validar formato del correo 
                // else if (cliente.correo) { !formatEmail(cliente.correo) ? this.msg = 'Formato de correo incorrecto' : this.msg = ''}
                else {
